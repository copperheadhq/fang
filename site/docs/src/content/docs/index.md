...
- [Three phases](/concepts/three-phases/) — elaboration, operation, commit
...
- [The commit gate](/concepts/the-commit-gate/) — six conditions, one path
- [Interfaces and lowering](/concepts/interfaces-and-lowering/) — how a connection becomes pins
- [Rationale](/concepts/rationale/) — the reasoning is in the graph
...
- [Simulation](/reference/simulation/) — plans, lowering, backends
