---
title: Three phases
description: Elaboration, operation, commit — and why the order matters.
sidebar:
  order: 1
---
...
converting it to a boolean, branching on it, comparing it — is an error.
...
`report.passed` is a symbolic condition recorded in the plan, resolved later.
